...
public class OneAddActivity extends AppCompatActivity {
    ...
    private TextView sId,hName,hAddress,hDescription,hCall,hEmail;
    private CardView card;
    private FloatingActionButton locationButton,callButton;
    private ImageButton toEmail,toCall;
    private ImageView image1,image2,image3;
    private ProgressBar progress3;
    private String id;

    private ArrayList<Double> cordList;
        ...
        Task<DocumentSnapshot> query = database.collection("Advertisements").document(id).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull @NotNull Task<DocumentSnapshot> task) {
                ...
                toCall.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (hCall.getText() == "no phone number provided"){
                            Toast.makeText(OneAddActivity.this, "no phone number provided", Toast.LENGTH_SHORT).show();
                        }else{
                            ...
                            Toast.makeText(OneAddActivity.this, "Phone number copied to clipboard", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                toEmail.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (hEmail.getText() == "no email address provided"){
                            Toast.makeText(OneAddActivity.this, "no email address provided", Toast.LENGTH_SHORT).show();
                        }else {
                            ...
                            Toast.makeText(OneAddActivity.this, "Email copied to clipboard", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                ...
                locationButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(OneAddActivity.this, "a maps application needed", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                ...
                callButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(place.get(1) == null){
                            Toast.makeText(OneAddActivity.this, "Phone number not provided", Toast.LENGTH_SHORT).show();
                        }else {
